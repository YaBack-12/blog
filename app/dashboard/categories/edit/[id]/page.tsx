    ...
    return (
        <div className="w-full h-screen bg-bg text-primary flex">
            <section className="flex-1 p-8 bg-gradient-to-br from-bg via-white/60 to-accent/10 text-primary min-h-screen">
                <h1 className="text-3xl font-extrabold mb-8">Edit Category</h1>
                <div className="w-full flex justify-center">
                    <form action={EditCategory.bind(null, catId)} className="w-full bg-white border border-muted rounded-2xl p-8 max-w-2xl space-y-6">
